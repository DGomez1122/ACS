...
export const VisitantBookingCard = ({
  _id,
  adminId,
  parkingLot,
  userName,
          ...
          >
            <Box>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>Nombre del visitante: </span>
                {userName}
              </Typography>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>ID del visitante: </span>
                {userId}
              </Typography>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>Número de vehículo: </span>
                {vehiclePlate}
              </Typography>
              {/* <Typography sx={{ color: "white" }} variant={"body2"}>
