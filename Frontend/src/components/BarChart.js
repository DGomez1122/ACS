...
export function BarChart({ yAxis, xAxis, horizontal }) {
    ...
    datasets: [
      {
        label: "Lunes",
        data: yAxis[0],
        borderColor: "rgba(163, 148, 255, 1)",
        backgroundColor: "rgba(163, 148, 255, 1)",
        color: "#fff",
        pointRadius: 5,
      },
      {
  ...
  return (
    <Box
      sx={{ width: "60vw", height: "90vh", margin: "0 auto" }}
