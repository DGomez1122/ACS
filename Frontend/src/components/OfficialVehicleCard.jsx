...
export const OfficialVehicleCard = ({
  plate,
  model,
  color,
  driverName,
          ...
          >
            <Box>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>Placa:</span> {plate}
              </Typography>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>Modelo:</span> {model}
              </Typography>
              <Typography sx={{ color: "white" }} variant={"body2"}>
                <span style={{ fontWeight: 700 }}>Color:</span> {color}
              </Typography>
              <Typography sx={{ color: "white" }} variant={"body2"}>
